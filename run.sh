...
High-value environment variables:
  ...
  SIM_Q6Q8                    Enable Q6 weights / Q8 activations replay with int8 power-of-2 block scale.
  SIM_Q6Q8_SRC0_BLOCK         src0 block size for Q6/Q8 replay.
  SIM_Q6Q8_SRC1_BLOCK         src1 block size for Q6/Q8 replay.
...
DEFAULT_SIM_Q6Q8="${SIM_Q6Q8:-0}"
DEFAULT_SIM_Q6Q8_APPLY_SRC0="${SIM_Q6Q8_APPLY_SRC0:-1}"
DEFAULT_SIM_Q6Q8_APPLY_SRC1="${SIM_Q6Q8_APPLY_SRC1:-1}"
DEFAULT_SIM_Q6Q8_SRC0_BLOCK="${SIM_Q6Q8_SRC0_BLOCK:-16}"
DEFAULT_SIM_Q6Q8_SRC1_BLOCK="${SIM_Q6Q8_SRC1_BLOCK:-16}"
...
|SIM_Q6Q8=0
|SIM_Q6Q8_APPLY_SRC0=1
|SIM_Q6Q8_APPLY_SRC1=1
|SIM_Q6Q8_SRC0_BLOCK=16
|SIM_Q6Q8_SRC1_BLOCK=16
|SIM_Q8Q8=0
...
remember_user_env_overrides() {
  ...
  local -a keys=(
    ...
    SIM_Q6Q8 SIM_Q6Q8_APPLY_SRC0 SIM_Q6Q8_APPLY_SRC1 SIM_Q6Q8_SRC0_BLOCK SIM_Q6Q8_SRC1_BLOCK
...
reset_case_defaults() {
  ...
  SIM_Q6Q8="${DEFAULT_SIM_Q6Q8}"
  SIM_Q6Q8_APPLY_SRC0="${DEFAULT_SIM_Q6Q8_APPLY_SRC0}"
  SIM_Q6Q8_APPLY_SRC1="${DEFAULT_SIM_Q6Q8_APPLY_SRC1}"
  SIM_Q6Q8_SRC0_BLOCK="${DEFAULT_SIM_Q6Q8_SRC0_BLOCK}"
  SIM_Q6Q8_SRC1_BLOCK="${DEFAULT_SIM_Q6Q8_SRC1_BLOCK}"
...
validate_case() {
  ...
  expect_one_of "SIM_Q6Q8" "${SIM_Q6Q8}" 0 1
  expect_one_of "SIM_Q6Q8_APPLY_SRC0" "${SIM_Q6Q8_APPLY_SRC0}" 0 1
  expect_one_of "SIM_Q6Q8_APPLY_SRC1" "${SIM_Q6Q8_APPLY_SRC1}" 0 1
  ...
  expect_positive_integer "SIM_Q6Q8_SRC0_BLOCK" "${SIM_Q6Q8_SRC0_BLOCK}"
  expect_positive_integer "SIM_Q6Q8_SRC1_BLOCK" "${SIM_Q6Q8_SRC1_BLOCK}"
  ...
  if [[ "${SIM_Q6Q8}" == "1" && "${SIM_FP8}" == "1" ]]; then
    die "SIM_Q6Q8 and SIM_FP8 cannot be enabled together"
  fi
  ...
  if [[ "${SIM_Q6Q8}" == "1" && "${SIM_Q4Q6}" == "1" ]]; then
    die "SIM_Q6Q8 and SIM_Q4Q6 cannot be enabled together"
  fi
  ...
  if [[ "${SIM_Q6Q8}" == "1" && "${SIM_Q6Q6}" == "1" ]]; then
    die "SIM_Q6Q8 and SIM_Q6Q6 cannot be enabled together"
  fi

  if [[ "${SIM_Q6Q8}" == "1" && "${SIM_Q8Q8}" == "1" ]]; then
    die "SIM_Q6Q8 and SIM_Q8Q8 cannot be enabled together"
  fi
  ...
  if [[ "${SIM_Q6Q8}" == "1" && "${SIM_MATMUL_OUT_MODE}" != "1" ]]; then
    die "SIM_Q6Q8 requires SIM_MATMUL_OUT_MODE=1 (BF16 output round-trip)"
  fi
...
build_case_flags() {
  ...
  -DGGML_SIM_Q6Q8=${SIM_Q6Q8} \
  -DGGML_SIM_Q6Q8_APPLY_SRC0=${SIM_Q6Q8_APPLY_SRC0} \
  -DGGML_SIM_Q6Q8_APPLY_SRC1=${SIM_Q6Q8_APPLY_SRC1} \
  -DGGML_SIM_Q6Q8_SRC0_BLOCK=${SIM_Q6Q8_SRC0_BLOCK} \
  -DGGML_SIM_Q6Q8_SRC1_BLOCK=${SIM_Q6Q8_SRC1_BLOCK} \
